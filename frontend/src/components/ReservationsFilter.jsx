export default function ReservationsFilter({filters, setFilters}){
  const statuses = ['All','Confirmed','Checked In','Pending','Cancelled']
  const types = ['All','Executive Suite','Deluxe Double','Standard King','Standard']
